    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
        <StatCard
          ...
          color="amber"
          loading={loading}
          subtitle={`${summary.billCount || 0} bills`}
        ...
        <StatCard
          ...
          color="green"
          loading={loading}
          subtitle={`${summary.paidBillCount || 0} paid`}
        />
        <StatCard
          label="Outstanding"
          ...
          color="red"
          loading={loading}
          subtitle={`${summary.creditBillCount || 0} pending`}
        ...
        <StatCard
          ...
          color="purple"
          loading={loading}
          subtitle={`${summary.returnCount || 0} returns`}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
        <ChartCard
          title="Sales Trend"
          subtitle="Daily sales over selected period"
          type="line"
          data={salesTrendData}
          loading={loading}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <div>
              <h3 className="text-sm font-semibold text-gray-200">Top Salespersons</h3>
              <p className="text-xs text-gray-500 mt-0.5">Performance leaderboard</p>
            </div>
            <button
              ...
              {(charts.topSalespersons || []).map((sp, idx) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] text-gray-500">{sp.count} bills • Commission: {formatPKR(sp.commission)}</p>
                  </div>
      ...
      {(charts.topBillers || []).length > 0 && (
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-gray-200">Biller Performance</h3>
            <span className="text-xs text-gray-500">{charts.topBillers.length} billers</span>
          </div>
          <div className="space-y-1.5">
            {(charts.topBillers || []).map((b, idx) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] text-gray-500">{b.count} bills processed</p>
                </div>
                <div className="text-right">
      ...
      >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2">
          {[
            { label: 'New Expense', icon: Plus, color: 'amber', path: '/manager/expenses' },
            { label: 'Collect Payment', icon: DollarSign, color: 'green', path: '/manager/credits' },
            { label: 'Open Shift', icon: Activity, color: 'blue', path: '/manager/shifts' },
            { label: 'Add Customer', icon: Users, color: 'purple', path: '/manager/customers' },
            { label: 'View Reports', icon: TrendingUp, color: 'orange', path: '/manager/reports' },
            { label: 'Activity Logs', icon: Eye, color: 'cyan', path: '/manager/activity' },
          ].map(action => {
